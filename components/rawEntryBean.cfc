<cfcomponent>
	...
	<cfscript>
		...
		function setApplicationCode(data) {
			variables.instance.applicationCode = left(arguments.data,100);
			return this;
		}
		...
		function setExternalId(data) {variables.instance.externalId = arguments.data; return this;}
		...
		function getExternalId() {return variables.instance.externalId;}
